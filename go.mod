module go.lumeweb.com/caddy-plugin-cert-webhook

//go:generate go run github.com/oapi-codegen/oapi-codegen/v2/cmd/oai-codegen -config oai-codegen.yaml swagger.yaml
...
require (
	...
	go.lumeweb.com/dane v0.0.1 // indirect
	go.lumeweb.com/ipfs-content v0.1.17 // indirect
